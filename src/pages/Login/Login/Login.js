...
const Login = () => {
    ...
    return (
        <div className=' container w-50 mx-auto'>
            ...
            {errorElement}
            <p className='w-50 mx-auto d-block'>New to Computer Warehouse ? <Link to="/register" className='text-primary pe-auto text-decoration-none' onClick={navigateRegister}>Please Register</Link></p>
